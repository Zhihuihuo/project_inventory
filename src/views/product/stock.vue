<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row @sort-change="sortChange">
      ...
      <el-table-column label="产品型号" align="center" width="100px">
        <template slot-scope="{row}">
          <span>{{ row.ptype }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="进价" align="center" width="90px">
        <template slot-scope="{row}">
          <span>{{ row.in_price }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="售价" align="center" width="90px">
        <template slot-scope="{row}">
          <span>{{ row.in_price }}</span>
        </template>
      </el-table-column>
