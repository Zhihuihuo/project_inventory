<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.salesman" placeholder="业务员" style="width: 160px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.code" placeholder="产品编码" style="width: 160px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row  @sort-change="sortChange">
      <el-table-column label="订单编号" prop="code" sortable="custom" align="center" width="130px" :class-name="getSortClass('id')">
